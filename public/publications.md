...
**Thomas Carr, Shuhan Yuan, Depeng Xu, Aidong Lu.** ECCV 2026 (Accepted). Project page: [tmr.thomasc.tech](https://tmr.thomasc.tech).
...
**Thomas Carr, Depeng Xu, Aidong Lu.** NeurIPS 2026 (Under Review). Project page: [mirage.thomasc.tech](https://mirage.thomasc.tech).
...
### Who You Are Is Not What You Do: Subject Identity Is Encoded but Unused in Skeleton-Based Action Recognition (CVPR 2027 Target)

**Thomas Carr, Xujun Che, Depeng Xu, Shuhan Yuan, Aidong Lu.** CVPR 2027 (Target).
